 ...
 */
class TracingRedisExecutorImpl implements RedisExecutor {
    private static final Logger LOGGER = LoggerFactory.getLogger(TracingRedisExecutorImpl.class);
    private final RedisSetting redisSetting;
    private final JedisPoolAbstract pool;

    private final String instance;

    TracingRedisExecutorImpl(RedisSetting redisSetting, JedisPoolAbstract pool) {
