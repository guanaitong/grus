...
import com.ciicgat.api.core.processor.AnnotatedParameterProcessor;
import com.ciicgat.api.core.processor.MatrixVariableParameterProcessor;
import com.ciicgat.api.core.processor.PathVariableParameterProcessor;
 ...
 * @version 2020-05-03 14:28
 */
public class GrusMvcContract extends Contract.BaseContract implements ResourceLoaderAware {
    ...
    public MethodMetadata parseAndValidateMetadata(Class<?> targetType, Method method) {
        ...
        if (apiTimeout != null) {
            md.template().header(CONNECT_TIMEOUT_TAG, String.valueOf(apiTimeout.connectTimeoutMillis()));
            md.template().header(READ_TIMEOUT_TAG, String.valueOf(apiTimeout.readTimeoutMillis()));
        }
    ...
    private void parseConsumes(MethodMetadata md, Method method,
        ...
        if (clientProduces != null) {
            ...
            md.template().header(CONTENT_TYPE, MediaType.APPLICATION_FORM_URLENCODED_VALUE);
        }
    }
